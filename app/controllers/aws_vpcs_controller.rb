class AwsVpcsController < ApplicationController
  ...
  private
    ...
    def aws_vpc_params
      params.require(:aws_vpc).permit(:name, :aws_name, :cidr_block, :instance_tenancy, :enable_dns_support, :enable_dns_hostnames, :subnet_base, :aws_account_id, :aws_region_id)
    end
end
